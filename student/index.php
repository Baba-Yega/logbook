...
<div class="jumbotron bg-info">
  ...
  <p class="lead">Welcome <span class="text-danger"><?php echo $user_name ?> </span> to your electronic logbook page make sure submit all required forms <br>and also fill your progress chart.</p>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen-lg-down">
    <div class="modal-content">
      ...
      <h5 class="text-danger">ITF Form</h5>
