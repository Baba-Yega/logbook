...
<div class="jumbotron bg-info text-center">
  ...
  <p class="lead">Welcome <span class="text-danger"><?php echo $user_name ?></span> to your electronic logbook for Student’s Industrial Work Experience Scheme Supervising page <br>You can now view and access student's progress chart.</p>
